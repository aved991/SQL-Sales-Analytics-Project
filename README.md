...
## This repo doesnot contain- recursive queries, sub queries, advanced Joins, Conditional Functions (CASE) <br>
## Prerequisite - SQL Query knowlegde, Microsoft SQL Server

## Superstore_orders is the main file <br>
